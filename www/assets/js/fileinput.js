(function(factory) {
    ...
    $h = {
        ...
        dataURI2Blob: function(dataURI) {
            var BlobBuilder = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder,
                ...
                byteStr, arrayBuffer, intArray, i, mimeStr, bb, canProceed = (canBlob || BlobBuilder) && window.atob && window.ArrayBuffer && window.Uint8Array;
            if (!canProceed) {
                return null;
            }
    ...
    FileInput.prototype = {
        ...
        _init: function(options) {
            ...
            self.isClickable = self.browseOnZoneClick && self.showPreview && (self.isUploadable && self.dropZoneEnabled || !$h.isEmpty(self.defaultPreviewContent));
        ...
        _initPreviewCache: function() {
            ...
            self.previewCache = {
                ...
                count: function(all) {
                    return !!self.previewCache.data && !!self.previewCache.data.content ? (all ? self.previewCache.data.content.length : self.previewCache.fetch().length) : 0;
                },
                get: function(i, isDisabled) {
                    var ind = 'init_' + i,
                        ...
                        out, $tmp, cat, ftr, fname, ftype, frameClass, asData = $h.ifSet('previewAsData', config, self.initialPreviewAsData),
                ...
                footer: function(i, isDisabled, size) {
                    ...
                    var config = data.config[i],
                        ...
                        actions, width = $h.ifSet('width', config, 'auto'),
        ...
        _uploadClick: function(e) {
            var self = this,
                ...
                $form, isEnabled = !$btn.hasClass('disabled') && $h.isEmpty($btn.attr('disabled'));
        ...
        _initZoomButtons: function() {
            var self = this,
                ...
                $first, $last, thumbs = self.getFrames().toArray(),
                len = thumbs.length,
        ...
        _setZoomContent: function($frame, animate) {
            var self = this,
                ...
                $btnBord = $modal.find('.btn-borderless'),
                cap, size, $btnTogh = $modal.find('.btn-toggleheader'),
        ...
        _zoomSlideShow: function(dir, previewId) {
            var self = this,
                ...
                $targFrame, i, thumbs = self.getFrames().toArray(),
                len = thumbs.length,
                out;
        ...
        _previewFile: function(i, file, theFile, previewId, data) {
            ...
            var self = this,
                ...
                content, chkMimes = mimes && mimes.indexOf(ftype) !== -1;
        ...
        _readFiles: function(files) {
            ...
            readFile = function(i) {
                ...
                var node = ctr + i,
                    ...
                    fSizeKB, caption = file.name ? self.slug(file.name) : '',
                    fileSize = (file.size || 0) / 1000,
                    j, msg,
                    fileExtExpr = '',
                    previewData = $h.objUrl.createObjectURL(file),
                    typ, chk, typ1, typ2, fileCount = 0,
                    strTypes = '',
                    func;
                if (typLen > 0) {
                    for (j = 0; j < typLen; j++) {
        ...
        _validateAllImages: function() {
            var self = this,
                ...
                config, fsize, minSize = self.resizeIfSizeMoreThan;
        ...
        _getResizedImage: function(config, counter, numImgs) {
            var self = this,
                ...
                dataURI, context = self.imageCanvasContext,
                type = config.typ,
                pid = config.pid,
                ind = config.ind,
                $thumb = config.thumb,
        ...
        _change: function(e) {
            var self = this,
                $el = self.$element;
            if (!self.isUploadable && $h.isEmpty($el.val()) && self.fileInputCleared) {
                self.fileInputCleared = false;
                return;
            }
            self.fileInputCleared = false;
            var tfiles = [],
                ...
                n, len, files = isDragDrop ? e.originalEvent.dataTransfer.files : $el.get(0).files,
                ctr = self.filestack.length,
